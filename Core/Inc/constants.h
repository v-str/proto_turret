...
#define PID_SERVICE_CALIBRATE "/turret_calibrate"  // ROS-сервис калибровки турели
...
#define ENC_HALF_RANGE (ENC_COUNTS_PER_TURN / 2)  // пол-оборота (граница обёртки)
...
// Моторы и калибровка
// ----------------------------------------------------------------------------
#define CALIB_STEP_DELAY_MS 2               // задержка между полушагами, мс (2 мс = 250 шаг/с)
#define CALIB_MAX_STEPS 30000               // таймаут концевика: число шагов (0 = отказ)
#define CALIB_PAUSE_MS 500                  // пауза между проходами оси, мс
// Уровни DIR. ПОЛЯРНОСТЬ ПРОВЕРИТЬ НА ЖЕЛЕЗЕ: если турель едет не туда —
// поменять местами RESET/SET.
